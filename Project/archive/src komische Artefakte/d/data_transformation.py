...
def get_data(parameters):
    ...
    if parameters['data'] == 'all':
        ...
        path_sin2 = os.path.join(parent_path, 'data', 'datasets', filename_cir2)
        ...
        data_sin2 = data_sin2[:int(data_sin2.shape[0]/2)]
...
def process_data(dataset, parameters, reshape):
    ...
    # '''
    features[np.nonzero(features < 0.0025)] = 0  # war 0.01
    features[np.nonzero(features > 0.9975)] = 1  # war 0.99
